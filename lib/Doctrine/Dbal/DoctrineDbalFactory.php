...
final class DoctrineDbalFactory
{
     ...
     */
    public function createCachedConditionGenerator(QueryBuilder $queryBuilder, SearchCondition $searchCondition, \DateInterval | int | null $ttl = 0): ConditionGenerator
    {
